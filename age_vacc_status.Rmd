...
after the first and second doses respectively. By observing the number of
children vaccinated in the 4 population strata as follows
...
By further assuming that the number of vaccinated children follows a Bernoulli
process, then we can estimate of the we can express the following likelihood:

$$
\mbox{L}(p_1, p_2, e_1, e_2 | N_1, N_2, N_3, N_4, V_1, V_2, V_3, V_4) = \prod_{i = 1}^4 \frac{N_i!}{V_i!(N_i - V_i)!}P_i^{N_i}(1 - P_i)^{N_i - V_i}
$$
